...
function MemberDashboardPage({ currentUser, tasks = [], projects = [] }) {
  ...
  return (
    <div className="px-4 sm:px-8 py-6 space-y-6">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-400 to-amber-500 px-6 py-7 sm:px-8 sm:py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <TodayWidget tasks={myTasks} currentUser={currentUser} projects={projects} />
