...
import { fetchDepartments, fetchUsers } from "../api/users.api";
...
function AdminProjectsPage({ projects = [], tasks = [], onCreateProject }) {
  ...
  return (
    <div className="px-8 py-6 space-y-6">
      ...
      <StatsGrid
        items={[
          { label: "Total projets", value: stats.total, icon: FolderKanban, accent: "#1D4ED8", accentBg: "#DBEAFE" },
          { label: "Actifs", value: stats.active, icon: CheckCircle2, accent: "#16A34A", accentBg: "#DCFCE7" },
          ...
          { label: "Progression moyenne", value: `${stats.avgProgress}%`, icon: TrendingUp, accent: "#7C3AED", accentBg: "#EDE9FE" },
        ]}
      />
